...
# forces all sessions to share a single connection so tables created in one
# session are visible in another — this is essential for the test suite and
# harmless for production (which uses a file-based DB).
_pool_kwargs: dict = (
